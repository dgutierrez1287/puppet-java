...
# jdkpath - the path where the jdk is installed
# too that you want to add the cacert to
# openjdk_version - the version of the openjdk that was
# installed, if intalled instead of a custom package
#
define java::jdk::cacert (
  $cacertpath = $title,
  $owner = 'root',
